...
class DQNAgent:
    ...
    def _build_model(self):
        ...
        x1 = Conv2D(16, (4, 4), strides=5(2, 2), activation='relu')(input_1)
...
if __name__ == '__main__':
    ...
    for e in range(episodes):
            ...
            if(action == 1):
                ...
                for i in range(16):
                    ...
                    traci.trafficlight.setPhaseDuration(
                        '1467490850', sumoInt.findDuration(turn, weight_matrix))
                traci.simulationStep()
        ...
        waiting_time_v1 = traci.vehicle(self, '-133305531#1')
